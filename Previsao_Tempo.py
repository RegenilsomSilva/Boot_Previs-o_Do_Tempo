...
print(os.linesep)
print("[italic blue]=================================================================================")
print("[italic red]======           AUTOMAÇÃO  |PREVISÃO DO TEMPO|          =========================")
print("[italic blue]=================================================================================")
print("[italic blue]=================================================================================")
...
class Tempo_Atual:
    def __init__(self):
        ...
        logging.info('O Dotenv é uma biblioteca Python que permite carregar variáveis de ambiente a partir de um arquivo .env.')
        ...
        logging.info(f'Configuração de Login {os.linesep}')
    ...
    def Condicoes_Meteorologicas(self):
        ...
        try:
            ...
            if 	self.Condicoes_Meteorologicas_Cidade is not None:
                ...
                logging.info('Encontramos....🎙️')
                print('[italic green]  🪟  Estamos Efetivamente dentro das Condições meteorológicas Da sua Cidade.')
                logging.info('🪟  Estamos Efetivamente dentro das Condições meteorológicas Da sua Cidade.')
                print(f'[italic green] Sua Cidade é 🇧🇷 : {self.Condicoes_Meteorologicas_Cidade[0].text}')
                logging.info(f'Sua Cidade é 🇧🇷 : {self.Condicoes_Meteorologicas_Cidade[0].text}')
            ...
            if self.Temperatura_Atual and self.Sencacao_termica is not None:
                ...
                logging.info(f' 🌡️ Encontramos. -> TEMPERATURA ATUAL 🌡️')
                print(f'[italic green] 🌞 Hoje a Temperatura Atual da sua Cidade é: {self.Temperatura_Atual[0].text} Graus')
                logging.info(f'🌞 Hoje a Temperatura Atual da sua Cidade é: {self.Temperatura_Atual[0].text} Graus')
                print(f'[italic green] ⛅ Sensação Termica da sua Cidade é 🌡️ de : {self.Sencacao_termica[0].text} Graus')
                logging.info(f'⛅ Sensação Termica da sua Cidade é 🌡️ de : {self.Sencacao_termica[0].text} Graus')
                print(os.linesep)
                logging.info(os.linesep)
        except:  
            print('[italic red]  🥵  Erro ao Verificar as Condições Atual.....')
            logging.critical(f'🥵  Erro ao Verificar as Condições Atual.....')
            print('[italic red]  🥹  Que tristeza.....')     
            logging.critical(f' 🥹  Que tristeza.....') 
    ...
    def Previsoes_Proximo_5_dias(self):
        ...
        try:
            ...
            logging.warning(" Criamos uma LISTA vazia, que irá receber a partir do 'FOR' as previsões futuras, Depois iremos disponibilizar no Campo de Envio de E-mails ")
            ...
            logging.info(f' 🤖🤖Obrigado por usar o Nosso Boot🤖🤖🤖 ')
            print(os.linesep) 
            logging.info(os.linesep)
        except:

            print('[italic red] 🥹 🥵 Erro Ao verificar as Previsões para os Próximos Dias.. 🥹 🥵')  
            logging.warning(f' 🥹 🥵 Erro Ao verificar as Previsões para os Próximos Dias.. 🥹 🥵 ')
    ...
    def Modulo_De_Envio(self):
        ...
        logging.info(f'🌞 Enviar previsão do 🌞 tempo Via E-mail 📧.{self.Mostrando_o_horario_que_enviou}')
        print('[italic green]   Criando configurações para o Envio de E-mail....')
        logging.info(f'Criando configurações para o Envio de E-mail....')
        ...
        logging.info(f'Iremos formatar o envio do E-mail via HTML...')
        ...
        try:
            ...
            logging.info(f'🙌🙌 Finalizamos a Configuração do Envio de E-mail via HTML & CSS 🙌🙌',os.linesep)
        
        except: 
            print('[italic red] 🥹🥵Erro Ao Formatar a Página em Html e Css... 🥹 🥵')
            logging.info('🥹 🥵 Erro Ao Formatar a Página em Html e Css... 🥹 🥵') 
# -------------------------------------PAREI AQUI--------------------------------------------------
        try:
